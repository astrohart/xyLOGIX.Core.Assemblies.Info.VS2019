...
- [AssemblyMetadata](#T-xyLOGIX-Core-Assemblies-Info-AssemblyMetadata 'xyLOGIX.Core.Assemblies.Info.AssemblyMetadata')
  ...
  - [#cctor()](#M-xyLOGIX-Core-Assemblies-Info-AssemblyMetadata-#cctor 'xyLOGIX.Core.Assemblies.Info.AssemblyMetadata.#cctor')
...
- [Find](#T-xyLOGIX-Core-Assemblies-Info-Find 'xyLOGIX.Core.Assemblies.Info.Find')
  - [#cctor()](#M-xyLOGIX-Core-Assemblies-Info-Find-#cctor 'xyLOGIX.Core.Assemblies.Info.Find.#cctor')
...
- [StackFrameExtensions](#T-xyLOGIX-Core-Assemblies-Info-StackFrameExtensions 'xyLOGIX.Core.Assemblies.Info.StackFrameExtensions')
  - [#cctor()](#M-xyLOGIX-Core-Assemblies-Info-StackFrameExtensions-#cctor 'xyLOGIX.Core.Assemblies.Info.StackFrameExtensions.#cctor')
...
Exposes `static` method(s) to obtain data from
various sources.
...
<a name='M-xyLOGIX-Core-Assemblies-Info-AssemblyMetadata-#cctor'></a>
### #cctor() `method`
...
[AssemblyMetadata](#T-xyLOGIX-Core-Assemblies-Info-AssemblyMetadata 'xyLOGIX.Core.Assemblies.Info.AssemblyMetadata') class.
...
Exposes `static` method(s) to find information on
assemblies through Reflection.

<a name='M-xyLOGIX-Core-Assemblies-Info-Find-#cctor'></a>
### #cctor() `method`
...
Initializes `static` data or performs actions that
need to be performed once only for the
[Find](#T-xyLOGIX-Core-Assemblies-Info-Find 'xyLOGIX.Core.Assemblies.Info.Find') class.
...
Initializes `static` data or performs actions that
need to be performed once only for the
[Get](#T-xyLOGIX-Core-Assemblies-Info-Get 'xyLOGIX.Core.Assemblies.Info.Get') class.
...
<a name='M-xyLOGIX-Core-Assemblies-Info-StackFrameExtensions-#cctor'></a>
### #cctor() `method`
...
Initializes `static` data or performs actions that
need to be performed once only for the
[StackFrameExtensions](#T-xyLOGIX-Core-Assemblies-Info-StackFrameExtensions 'xyLOGIX.Core.Assemblies.Info.StackFrameExtensions') class.
